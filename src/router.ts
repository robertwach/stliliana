...
export const router = (app: Application) => {
  ...
  app.get("/blog-details/:url", async (req, res) => {
    ...
    const seoholder = {_id: "", page:"", title: title, meta: meta,  header_1:"st lilyann school", code:"code", content:"description"}
    const seo = seoholder
    const blogs = await getBlogs(req, res)
  ...
  app.get("/contact-us", async (req, res) => {
    const seoholder =
     {_id: "", page:"", title:"st lilyann school", meta:"st lilyann school",  header_1:"st lilyann school", code:"code", content:"description"}
